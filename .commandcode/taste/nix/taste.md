...
- Superseded 2026-07: Ansible's Mac path (playbooks/mac.yml, public-mac.yml, roles/*/tasks/darwin.yml) was deleted — Nix is now the sole provisioner for macOS, not just the primary one. Ansible is Linux-only going forward. Confidence: 0.85
